export default {
  ...
  auth: {
    ...
    verifyLinkInvalid: 'Verification link is invalid or expired, please register again.',
    ...
    emailSentDesc: 'We sent a password reset email to',
    emailSentCheck: 'Please check your email and click the link to reset your password',
    registerEmailSentTitle: 'Email Sent',
    registerEmailSentDesc: 'We sent an email to',
    registerEmailSentCheck:
      'To complete registration, please check your email and click to activate your account',
    typeButton: 'Type',
    nameButton: 'Name',
  ...
  storage: {
    ...
    selectBucketToBrowse: 'Select a bucket in the "Buckets" tab to browse objects',
    ...
    nfsExample: 'NFS example: vers=3,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2',
    cifsExample: 'CIFS example: vers=3.0,iocharset=utf8,file_mode=0777,dir_mode=0777',
    provider: 'Provider',
    ...
    noBoundNodeForStats: 'This storage is not bound to any node, cannot get statistics',
    ...
    noBoundNodeForRefreshStats: 'This storage is not bound to any node, cannot refresh statistics',
    statsUpdated: 'Statistics updated',
    updateStatsFailed: 'Failed to update statistics',
    noBoundNodeForDownload: 'This storage is not bound to any node, cannot download file',
    downloadTaskCreated: 'File download task created, Task ID: {taskId}',
    downloadFailed: 'Download failed',
    noBoundNodeForFileList: 'This storage is not bound to any node, cannot get file list',
    fileListTaskCreated: 'File list task created, Task ID: {taskId}',
    getFileListFailed: 'Failed to get file list',
    noBoundNodeForBucketList: 'This storage is not bound to any node, cannot get bucket list',
    bucketListTaskCreated: 'Bucket list task created, Task ID: {taskId}',
    getBucketListFailed: 'Failed to get bucket list',
    noBoundNodeForObjectList: 'This storage is not bound to any node, cannot get object list',
    ...
    testNodeNotExists: 'Selected test node does not exist or is offline, please reselect node',
    testNodeOffline:
    ...
    connectionTestTaskCreated: 'Connection test task created, Task ID: {taskId}',
    ...
    deleteFailed: 'Delete failed',
    testConnectionSuccess: 'Real-time connection test successful! Response time: {time}ms',
    testConnectionTimeout: 'Connection test timeout, please check network or storage configuration',
    testConnectionFailed: 'Real-time connection test failed',
    getInfoSuccess: 'Real-time get info successful! Execution time: {time}s',
    getInfoTimeout: 'Get info timeout, please check network or storage configuration',
  ...
  tasks: {
    ...
    description: 'Manage and monitor synchronization task creation, execution and status',
  ...
  taskWizard: {
    ...
    // Messages
    messages: {
      completeAllRequiredConfig: 'Please complete all required configuration information',
  ...
  targetSelector: {
    ...
    selectTargetStorageDesc: 'Please select the target storage device to sync to',
    ...
    targetPath: 'Target Path',
    targetPathPlaceholder: 'Optional: Specify path within bucket, e.g. folder1/subfolder',
  ...
  obsToObsOptions: {
    ...
    rcloneArgsTip: 'Custom rclone arguments, separate multiple arguments with spaces',
  ...
  nasToNasOptions: {
    ...
    rsyncArgsTip: 'Custom rsync arguments, separate multiple arguments with spaces',
    syncMode: 'Sync Mode',
    ...
    preservePermissionsTip: 'Whether to preserve file permissions and owner information',
  ...
  notifications: {
    ...
    messages: {
      ...
      confirmMarkAllAsRead: 'Are you sure you want to mark all unread messages as read?',
  ...
  alertPolicies: {
    ...
    pageDescription: 'Manage system alert policies, monitor resource status and events',
    ...
    selectAlertPolicy: 'Please select alert policy',
    ...
    validation: {
      enterPolicyName: 'Please enter policy name',
      policyNameLength: 'Policy name length should be between 2 and 50 characters',
    ...
    messages: {
      ...
      confirmDeletePolicy: 'Are you sure you want to delete alert policy "{policyName}"?',
      confirmDelete: 'Confirm Delete',
      confirm: 'Confirm',
      cancel: 'Cancel',
      deleteSuccess: 'Delete successful',
  ...
  settings: {
    ...
    maxConcurrentTasksTip: 'Maximum number of tasks that can run simultaneously',
    ...
    messages: {
      ...
      testNotificationSent: 'Test notification sent, please check the corresponding channel',
  ...
  nodes: {
    serverIp: 'Service Address',
    serverPort: 'Server Port',
    serverIpTip:
      'The server IP address is the service address of the EasySync server that the EasySync-Proxy can connect to',
    serverPortTip:
      'The server port is the port of the EasySync server that the EasySync-Proxy can connect to',
    serverIpPlaceholder: 'Please enter the service address of the EasySync server',
    serverPortPlaceholder: 'Please enter the port of the EasySync server',
    ...
    pageSubtitle: 'Manage your EasySync-Proxy nodes for data synchronization tasks',
    ...
    proxyDescription: 'Responsible for mounting both storage ends and executing data sync tasks',
    proxyFeatures: 'Supports bidirectional sync, task distribution, status monitoring',
    description: 'Description',
    ...
    step1Description: 'Register one or more servers as SyncProxy as the sync hub',
    ...
    enterNewGroupName: 'Please enter new group name (leave empty to clear group)',
    enterNewTags: 'Please enter new tags, separated by commas (leave empty to clear tags)',
    timestamp: 'Time',
    level: 'Level',
    module: 'Module',
    message: 'Message',
  ...
  monitoring: {
    ...
    messages: {
      ...
      monitoringSettingsInDevelopment: 'Monitoring settings feature is under development...',
    },
  ...
  clients: {
    ...
    pageSubtitle: 'Manage your source servers, install Agent to sync local data to target storage',
    ...
    agentAutoCollect: 'Agent automatically collects system resource information',
    syncProxy: '2. Sync Proxy (Nodes)',
    syncProxyDesc: 'Data sync intermediate node, responsible for data transmission and conversion',
    ...
    targetStorageDesc: 'Data sync target location, supports multiple storage types',
    ...
    addSourceServerStepDesc: 'Register your source server, configure SSH connection information',
    installAgentStep: 'Install Agent',
    installAgentStepDesc: 'Install EasySync Agent on source server for data collection',
    configureSyncStep: 'Configure Sync Task',
    configureSyncStepDesc: 'Select source directory and target storage, create data sync task',
    startSyncStep: 'Start Sync',
    startSyncStepDesc: 'Agent automatically collects data and syncs to target storage',
    onlineServers: 'Online Servers',
    offlineServers: 'Offline Servers',
    runningAgents: 'Running Agents',
    pendingAgents: 'Pending Agents',
  ...
  notification: {
    ...
    targets: {
      ...
      description:
        'Manage system notification targets, supporting email, SMS, WebHook and other notification methods',
      createTarget: 'Create Notification Target',
      targetName: 'Target Name',
      targetType: 'Target Type',
      targetStatus: 'Target Status',
      targetAddress: 'Notification Address',
      createTime: 'Create Time',
      actions: 'Actions',
      enabled: 'Enabled',
      disabled: 'Disabled',
      ...
      unbound: 'Unbound',
      noDescription: 'No Description',
      noTargets: 'No notification targets',
      createFirstTarget: 'Create first notification target',
      targetTypes: {
        email: 'Email',
        sms: 'SMS',
        webhook: 'WebHook',
      ...
      messages: {
        createSuccess: 'Notification target created successfully',
        updateSuccess: 'Notification target updated successfully',
        deleteSuccess: 'Notification target deleted successfully',
        createFailed: 'Failed to create notification target',
        updateFailed: 'Failed to update notification target',
        deleteFailed: 'Failed to delete notification target',
        getTargetsFailed: 'Failed to get notification targets',
        operationFailed: 'Operation failed',
      },
    },
    ...
    channels: {
      ...
      description:
        'Manage system notification channels, supporting email, SMS, WebHook and other notification methods',
      selectChannel: 'Please select notification channel',
      ...
      messages: {
        ...
        updateSuccess: 'Notification channel updated successfully',
        deleteSuccess: 'Notification channel deleted successfully',
        ...
        getChannelsFailed: 'Failed to get notification channels',
        operationFailed: 'Operation failed',
        confirmDelete:
          'Are you sure to delete notification channel "{name}"? This action cannot be undone.',
        confirmTest: 'Are you sure to test notification channel "{name}"?',
      },
    },
  },
  ...
  logs: {
    ...
    bytesProcessed: 'Data Processed',
    details: 'Details',
    logDetail: 'Log Detail',
    errorMessage: 'Error Message',
    processedFiles: 'Processed Files List',
    filePath: 'File Path',
    size: 'Size',
    fileStatus: 'Status',
    exportSuccess: 'Log export successful',
    exportFailed: 'Log export failed',
    getTasksFailed: 'Failed to get task list',
    getLogsFailed: 'Failed to get log list',
    getLogDetailFailed: 'Failed to get log detail',
  },
  ...
  audit: {
    ...
    task: 'Task',
    client: 'Client',
    loginLogoutAudit: 'Login/Logout Audit Logs',
    operationAuditLog: 'Operation Audit Logs',
    totalRecords: 'Total {count} records',
    id: 'ID',
    username: 'User',
    ...
    resourceNameDetail: 'Resource Name',
    ipAddressDetail: 'IP Address',
  ...
  alertTemplates: {
    title: 'Alert Notification Template Management',
    description:
      'Manage system alert notification templates, supporting email, SMS, DingTalk and other notification methods',
    ...
    edit: 'Edit',
    delete: 'Delete',
    noTemplates: 'No alert templates',
    editTemplate: 'Edit Template',
    createTemplateDialog: 'Create Template',
    templateDescription: 'Template Description',
    enterTemplateName: 'Please enter template name',
    enterDescription: 'Please enter template description',
    titleTemplate: 'Title Template',
    contentTemplate: 'Content Template',
    enterTitleTemplate:
      'Please enter title template, supporting variables like {alert_name} {severity}',
    enterContentTemplate:
      'Please enter content template, supporting variables like {alert_name} {severity} {resource_name} {current_value} {threshold} {triggered_at} {description}',
    variableConfig: 'Variable Config',
    supportedVariables: 'Supported Variables',
    selectVariables: 'Select supported variables',
    alertName: 'Alert Name',
    alertLevel: 'Alert Level',
    resourceName: 'Resource Name',
    ...
    contentTemplateLabel: 'Content Template',
    supportedVariablesSection: 'Supported Variables',
    ...
    messages: {
      ...
      previewFailed: 'Failed to preview template',
    ...
    previewFailed: 'Failed to preview template',
    checkFormError: 'Please check if the form is filled correctly',
    updateSuccess: 'Template updated successfully',
    createSuccess: 'Template created successfully',
    ...
    deleteSuccess: 'Template deleted successfully',
    deleteFailed: 'Failed to delete template',
    templateContentConfig: 'Template Content Config',
    content: 'Content',
    templateDetails: 'Template Details',
    testData: {
      alertName: 'CPU Usage Alert',
      resourceName: 'Server-01',
      description: 'CPU usage exceeds threshold, please handle promptly',
      nodeName: 'Node-01',
  ...
  errors: {
    ...
    errorRecorded: 'Error has been recorded, we will handle it as soon as possible',
    fetchUserFailed: 'Failed to fetch user information',
    componentRenderErrorWithHint: 'Component render error, please refresh and try again',
  ...
  taskWizard: {
    ...
    selectTargetStorageAndPathDesc: 'Please select target storage and specify the destination path',
    configureTaskParameters: 'Configure task parameters',
    configureTaskParametersDesc: 'Configure sync parameters based on source and target types',
    ...
    warnings: {
      sourceInitTimeout: 'Copy config may be incomplete. Please check the source settings',
    ...
    messages: {
      completeAllRequiredConfig: 'Please complete all required configuration first',
      taskCreatedSuccess: 'Task created successfully',
      createTaskFailed: 'Failed to create task',
    },
    steps: {
  ...
  socket: {
    ...
    connectFailedRetry: 'Failed to connect to server, please refresh and try again',
